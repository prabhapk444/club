...
<body>
    <div class="form-container">
        <h4>Gallery Images Upload  Here</h4>
        <form action="" method="post" enctype="multipart/form-data">
            <input type="file" name="image" required>
            <input type="submit" value="Upload Image" class="btn btn-warning">
        </form>
        <div class="icons-container">
            <a href="galleryupdate.php" class="update-icon"><i class="fas fa-edit"></i> Update</a>
            <a href="gallerydelete.php" class="delete-icon"><i class="fas fa-trash-alt"></i> Delete</a>
        </div>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['image'])) {
    ...
    if (move_uploaded_file($_FILES['image']['tmp_name'], $uploadFile)) {
        ...
        $sql = "INSERT INTO gallery (photo) VALUES ('$filePath')";
